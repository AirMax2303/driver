...
class _$_DriverModel implements _DriverModel {
  ...
  @override
  String toString() {
    return 'DriverModel(id: $id, phone: $phone, password: $password, town: $town, refcode: $refcode, country: $country, surname: $surname, name: $name, numberDL: $numberDL, dateDL: $dateDL, carbrand: $carbrand, carmodel: $carmodel, carcolor: $carcolor, caryear: $caryear, carNP: $carNP, carCTC: $carCTC, carType: $carType, description: $description, age: $age, image: $image, video: $video, question: $question, question0: $question0, question1: $question1, question2: $question2, question3: $question3, question4: $question4, question5: $question5, question6: $question6, question7: $question7)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.numberDL, numberDL) ||
                other.numberDL == numberDL) &&
            (identical(other.dateDL, dateDL) || other.dateDL == dateDL) &&
            ...
            (identical(other.carNP, carNP) || other.carNP == carNP) &&
            (identical(other.carCTC, carCTC) || other.carCTC == carCTC) &&
            ...
            (identical(other.question0, question0) ||
                other.question0 == question0) &&
